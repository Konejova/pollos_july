...
#################################################################################
{
  ...
  "assets"               :  {
                              'point_of_sale.assets': [
                                "/pos_combo_products/static/src/js/models.js",
                                "/pos_combo_products/static/src/js/screens.js",
                                "/pos_combo_products/static/src/js/popup.js",
                                "/pos_combo_products/static/src/css/pos.css",
                                'pos_combo_products/static/src/xml/pos.xml',
                              ],
                            },
  "demo"                 :  ['demo/demo.xml'],
