                    ...
                    if not payment['cash']:
                        for account_payment in account_payments:
                            if payment['id'] == account_payment.pos_payment_method_id.id:
                                ...
                                payment['cash_moves'] = []
                                payment['cash_in_out'] = [] #Para el control de ingreso y salida
                        ...
                        cash_in_count = 0
                        cash_out_count = 0
                        cash_control = [] #Para el control de ingreso y salida
                        ...
                        for cash_move in cash_moves:
                            ...
                            if cash_move.move_id.journal_id.id == payment['journal_id']:
                                ...
                                if cash_move.payment_ref and ("out" in cash_move.payment_ref[9:13] or "in" in cash_move.payment_ref[9:13]):
                                    cash_control.append({
                                        'name': cash_move.payment_ref[14:] if cash_move.payment_ref else name,
                                        'amount': cash_move.amount
                                    })
                        payment['cash_moves'] = cash_in_out_list
                        payment['cash_in_out'] = cash_control
                        payment['count'] = True
